...
import { View, Text, StyleSheet, Pressable, Dimensions, ImageBackground, ScrollView, SafeAreaView } from 'react-native'
    ...
    return (
        // <SafeAreaView style={{ backgroundColor: 'white' }}>
            <ScrollView style={styles.scrollView}>
                <ImageBackground source={require('../../assets/1d.png')} style={{ width: '100%', height: '100%', flex: 1 }}>
