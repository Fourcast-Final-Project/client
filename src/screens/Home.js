    ...
    return (
        <>
            <View style={ styles.container }>
                ...
                {location.length > 0 && weather.main ? (<ImageBackground source={weather.weather[0].main === 'Haze' ? require('../../assets/haze2.png') : ((weather.weather[0].main === 'Sunny' || weather.weather[0].main === 'Clear') ? require('../../assets/sunny.png') : require('../../assets/rain2.png'))} style={{ width: '100%', height: '100%', flex: 1 }}>
